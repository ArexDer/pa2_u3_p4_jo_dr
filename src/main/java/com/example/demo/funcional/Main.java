...
public class Main {
	...
	public static void main(String[] args) {
		...
		/*
		 * METODOS REFERENCIADOS se lo hace mediante "::"
		 */
		...
		/*
		 * METODOS REFERENCIADOS EN CONSUMER se lo hace mediante "::"
		 */
		...
		/*
		 * METODOS REFERENCIADOS EN PREDICATE se lo hace mediante "::"
		 */
		...
		/*
		 * METODOS REFERENCIADOS EN FUNCTION se lo hace mediante "::"
		 */
		IPersonaFunction<String, Integer> functionM = metodos::aplicar;
		LOG.info("FUNCTION  (Metodos Referenciados): " + functionM.aplicar(100));
		...
		/*
		 * METODO REFERENCIADO CON UNARY OPERATION
		 */
		IPersonaUnaryOperator<String> unaryM = metodos::aplicarUnary;
		LOG.info("UNARY  (Metodos Referenciados): " + unaryM.aplicar("Diego"));

		// TERCER TIPO DE IMLEMENTACION HIGH ORDER(SIRVEN PARA ESPECIFICAR UN TIPO DE
		// FUNCIONALIDAD ADICIONAL9
		// Tambien se lo conoce como METODS REFERENCIADOS
		/*
		 * Mientras se cumpla el contrato, yo le puedo pasar como una implementacion de
